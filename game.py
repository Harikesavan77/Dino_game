...
def display_score():
    ...
    score_surf_rect = score_surf.get_rect(center=(400,80))
...
pygame.display.set_caption("Spartan's World")
clock = pygame.time.Clock()
test_font = pygame.font.Font('Pixeltype.ttf',55)
start_time = 0
score = 0
game_activity = False
...
text_surface = test_font.render('Spartan Game',False,(20,20,20))
...
fly_frame_index = 0
fly_surface = snail_frames[fly_frame_index]
...
player_stand_surface = pygame.transform.rotozoom(player_stand,0,1.5)
player_stand_rect = player_stand_surface.get_rect(center=(400,200))

message_surface = test_font.render('Press Space To Run','False',(20,20,20))
message_surface_rect = message_surface.get_rect(center=(400,325))
...
while True:
    for event in pygame.event.get():
        ...
        if game_activity:
            if event.type == obstacle_timer:
                if randint(0,2):
                    obstacle_rect_list.append(snail_surface.get_rect(bottomright=(randint(900,1150),300)))
                else:
                    obstacle_rect_list.append(fly_surface.get_rect(bottomright=(randint(900,1150),210)))
    ...
    if game_activity:
        ...
        #pygame.draw.rect(screen,'#c0e9ec',text_rect,12)
        ...
        game_activity = collisions(player_rect,obstacle_rect_list)
